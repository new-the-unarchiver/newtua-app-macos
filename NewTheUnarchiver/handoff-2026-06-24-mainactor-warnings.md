...
статус: ✅ ЗАВЕРШЕНО 2026-06-24, commit ce7f2c0. Решение зафиксировано
        в `decisions.md` («Stage 10.1») и в `plan.md` («Этап 10.1»).
        Файл оставлен как исторический документ — план разбора
        проблемы и обоснование выбора Подхода А.
---
